...
CXXFLAGS=-Wall -Wno-unknown-pragmas -std=c++17 -O2 -DPROTOCOL_VERSION=$(PROTOCOL_VERSION) -DGIT_VERSION=\"$(GIT_VERSION)\" -I./cosmo/src #-g3 -fsanitize=address
...
WIN_CXXFLAGS=-D_WIN32_WINNT=0x0601 -Wall -Wno-unknown-pragmas -std=c++17 -O3 $(WIN_CXX_OPT_DISABLES) -DPROTOCOL_VERSION=$(PROTOCOL_VERSION) -DGIT_VERSION=\"$(GIT_VERSION)\" -I./cosmo/src #-g3 -fsanitize=address
...
CXXSRC=\
	...
	src/Monitor.cpp\
	src/prototypes/CosmoManager.cpp\
...
CXXHDR=\
	...
	src/Monitor.hpp\
	src/prototypes/CosmoManager.hpp\
